<div>
    ...
    @include('livewire.admin.producto.modalcrearproducto')
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($productos as $onlyproduct)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{$onlyproduct->descripcion}}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a class="btn2 btn-blue mb-1 py-2" wire:click="edit({{$onlyproduct->id}})">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn2 btn-red mb-1 py-2"
                                        wire:click="$emit('delethis',{{$onlyproduct->id}})">
